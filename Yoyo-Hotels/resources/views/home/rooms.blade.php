...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <ul class="top-widget">
            <li><i class="fa fa-phone"></i>+977 9824305635</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-10">
                    ...
                    <div class="room-item">
                        ...
                        <div class="ri-text">
                            <h4 style="font-size: 25px;">{{$rooms->room_title}}</h4>
                            <h3 style="font-size: 22px;">Rs.{{$rooms->price}}<span style="font-size: 17px;">/Pernight</span></h3>
                            <table>
                                <tbody>
